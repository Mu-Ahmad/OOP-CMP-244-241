...
int main(){
	...
	r1[4].set(2,1);
	r1[5].set(1,3);
	file1.write ( (char *)r1, sizeof(RationalNumber) * 6);
	file1.close();
	...
	int count = file2.tellg() / sizeof (RationalNumber);
	r2 = new RationalNumber [count];
	file2.seekg(0);
	file2.read  ( (char *)r2, sizeof(RationalNumber) * count);

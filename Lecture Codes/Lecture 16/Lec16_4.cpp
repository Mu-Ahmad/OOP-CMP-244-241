...
class B{
	A *a;//May be strong aggregation
public:
	B(){	
		a = new A;//Strong aggregation is implemented by creating object inside constructor
		cout << "Object of B is created\n";
	}
	~B(){	
		cout << "Object of B is removed\n";
		delete a;//Strong aggregation is implemented by removing object inside destructor
	}
